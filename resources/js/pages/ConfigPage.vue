<template>
          ...
          <div class="container mx-auto my-10 px-4 h-full">
             <div class="flex content-center items-center justify-center h-full">
                <div class="w-full md:w-3/4 lg:w-6/12 xl:w-4/12 px-4">
                   <div
                      class="relative flex flex-col min-w-0 break-words w-full mb-6 bg-gray-700 border-1"
                   >
 ...
 export default {
    ...
    beforeDestroy() {
       // Restaurar el color de fondo original del body cuando el componente se desmonte
    ...
    methods: {
       guardarSeleccion() {
          ...
          // Guardar selección en localStorage u otra lógica
          localStorage.setItem('puesto', this.formData.puesto);
          localStorage.setItem('sede', this.formData.sede);
