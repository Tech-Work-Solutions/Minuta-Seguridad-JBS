<template>
   <div v-if="show">
      <div class="flex flex-wrap items-center">
         <h1 class="text-xl text-gray-500 pl-5 mr-5 font-bold"><em class="fas fa-users "></em> Registro de Visitantes</h1>
      </div>
            ...
            <form>
               <div class="flex flex-wrap mt-6">
                  ...
                  <div class="w-full lg:w-4/12 px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.numero_documento.numeric">Ingrese solo numeros</p>
                     </div>
                  </div>
                  ...
                  <div class="w-full lg:w-4/12 px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.tipo.required">Seleccione una opcion</p>
                  </div>
                  ...
                  <div class="w-full lg:w-4/12 px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.nombres.required">Ingrese el nombre</p>
                  </div>
                  ...
                  <div class="w-full lg:w-4/12 px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.apellidos.required">Ingrese el apellido</p>
                  </div>
                  ...
                  <div class="w-full lg:w-4/12 px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.eps_id.required">Seleccione una EPS</p>
                  </div>
                  ...
                  <div class="w-full lg:w-4/12 px-4">
                     ...
                     <t-rich-select
                        v-model="formData.arl_id"
                        :options="arls"
                        placeholder="Seleccione una opción"
                     >
                     </t-rich-select>
                     </div>
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.arl_id.required">Seleccione una ARL</p>
                  </div>
