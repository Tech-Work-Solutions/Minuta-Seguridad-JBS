<template>
   <div v-if="show">
      <div class="flex flex-wrap items-center">
         <h1 class="text-xl text-gray-500 pl-5 mr-5 font-bold"><em class="fas fa-file-signature"></em> Registro de Minuta</h1>
      </div>
            ...
            <form>
               <div class="flex flex-wrap mt-6">
                  <div class="w-full lg:w-6/12  px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.subject_id.required">Seleccione un asunto</p>
                  </div>
                  ...
                  <div class="w-full lg:w-6/12  px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.ubicacion_id.required">Seleccione un puesto o ubicación</p>
                  </div>
                  ...
                  <div class="w-full px-4">
                     ...
                     <p class="text-red-500 text-sm" v-if="submited && !$v.formData.anotaciones.required">Ingrese las anotaciones correspondientes</p>
                     </div>
                  </div>
               </div>                    
