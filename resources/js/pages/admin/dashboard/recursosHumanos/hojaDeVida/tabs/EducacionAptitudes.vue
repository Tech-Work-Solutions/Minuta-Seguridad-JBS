<template>
  <div class="p-8 bg-gray-100">
    <form @submit.prevent="handleSubmit" class="bg-white rounded-lg shadow p-6">
          ...
          <tbody>
            <tr v-for="nivel in nivelesEstudio" :key="nivel.id">
              <td class="border border-gray-300 p-2" style="width: 150px;">
                ...
                <select v-model="formData[`${nivel.key}Select`]"
              ...
              <td class="border border-gray-300 p-2">
                <input v-model="formData[`${nivel.key}Titulo`]" type="text" :name="`${nivel.key}Titulo`"
                  class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none" />
              </td>
              <td class="border border-gray-300 p-2">
                <input v-model="formData[`${nivel.key}AnoFinalizacion`]" type="number"
                  :name="`${nivel.key}AnoFinalizacion`"
                  class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none" />
              </td>
              <td class="border border-gray-300 p-2">
                <input v-model="formData[`${nivel.key}AnosCursados`]" type="number" :name="`${nivel.key}AnosCursados`"
                  class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none" />
              </td>
              <td class="border border-gray-300 p-2">
                <input v-model="formData[`${nivel.key}Institucion`]" type="text" :name="`${nivel.key}Institucion`"
                  class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none" />
              </td>
              <td class="border border-gray-300 p-2">
                <input v-model="formData[`${nivel.key}Ciudad`]" type="text" :name="`${nivel.key}Ciudad`"
                  class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none" />
              </td>
            </tr>
          </tbody>
      ...
      <div class="p-4 border-t border-gray-300">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-5 gap-4 mt-2">
          <div class="col-span-1">
            ...
            <input type="number" placeholder="Horas" class="w-full p-1 border border-gray-300 rounded mt-1"
              v-model="formData.intesidadHoraria" :disabled="!formData.nombreDelPrograma" />
          ...
          <div class="col-span-3">
            ...
            <input type="text" placeholder="Nombre del programa" class="w-full p-1 border border-gray-300 rounded mt-1"
              v-model="formData.nombreDelPrograma" />
          </div>
          <div class="col-span-1">
            <label class="block text-sm font-medium text-gray-600">Institución</label>
            <input type="text" placeholder="Nombre" class="w-full p-1 border border-gray-300 rounded mt-1"
              v-model="formData.institucion" :disabled="!formData.nombreDelPrograma" />
      ...
      <div class="p-4 border-t border-gray-300">
        <div class="grid grid-cols-1 sm:grid-cols-9 gap-4 mt-2">
          <div class="col-span-1 sm:col-span-2">
            <label class="block text-sm font-medium text-gray-600">¿Cursa estudios <span class="hidden sm:inline"> <br>
              </span> actualmente? </label>
            <div class="flex items-center space-x-4">
              <label>
                <input v-model="formData.cursaEstudios" type="radio" value="Si" class="form-radio text-blue-600" />
                Si
              </label>
              <label>
                <input v-model="formData.cursaEstudios" type="radio" value="No" class="form-radio text-blue-600" />
                No
              </label>
            </div>
          ...
          <div class="col-span-1 sm:col-span-3">
            <label class="block text-sm font-medium text-gray-600">¿Qué tipo de<br class="hidden sm:inline"> estudios?
            </label>
            <input type="text" class="w-full p-1 border border-gray-300 rounded mt-1" v-model="formData.tipoEstudios"
          ...
          <div class="col-span-1 sm:col-span-2">
            <label class="block text-sm font-medium text-gray-600">Duración<br class="hidden sm:inline"> (años,
              semestres, meses)</label>
            <input type="text" class="w-full p-1 border border-gray-300 rounded mt-1"
          ...
          <div class="col-span-1 sm:col-span-2">
            <label class="block text-sm font-medium text-gray-600">Año / semestre que<br class="hidden sm:inline">
              cursa</label>
            <input type="number" class="w-full p-1 border border-gray-300 rounded mt-1" v-model="formData.semestreCursa"
              :disabled="formData.cursaEstudios === 'No' || !formData.cursaEstudios" />
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
          ...
          <div class="col-span-1 sm:col-span-1">
            ...
            <select v-model="formData.horario"
              class="w-full px-3 py-2 border rounded-lg text-gray-700 focus:outline-none"
              :disabled="formData.cursaEstudios === 'No' || !formData.cursaEstudios">
              <option value="">Seleccione...</option>
      ...
      <div class="p-4 border-t border-gray-300">
        <label class="block text-sm font-medium text-gray-600">OTROS CONOCIMIENTOS: Indique el grado de dominio R -
          Regular, B - Bien, MB - Muy Bien</label>
        <div class="overflow-x-auto mt-4">
          <table class="table-auto w-full text-sm border-collapse border border-gray-300">
            <tbody>
              <tr>
                ...
                <td class="border border-gray-300 p-2">
                  <div class="flex items-center space-x-2">
                    <input type="text" class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none"
                      placeholder="Programa 1" v-model="formData.programa1"
                ...
                <td class="border border-gray-300 p-2 text-center">
                  <div class="flex space-x-2">
                    ...
                    <input type="radio" v-model="formData.nivelP1" value="R" class="mr-2"
                      :disabled="!formData.programa1" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.nivelP1" value="B" class="mr-2"
                      :disabled="!formData.programa1" />
                ...
                <td class="border border-gray-300 p-2">
                  <div class="flex items-center space-x-2">
                    <input type="text" class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none"
                      placeholder="Programa 3" v-model="formData.programa3"
                      :disabled="formData.sistemas === 'No' || !formData.sistemas" />
                  </div>
                </td>
                <td class="border border-gray-300 p-2 text-center">
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.nivelP3" value="R" class="mr-2"
                      :disabled="!formData.programa3" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.nivelP3" value="B" class="mr-2"
                      :disabled="!formData.programa3" />
                    <label class="mr-2">MB</label>
              ...
              <tr>
                <td class="border border-gray-300 p-2">
                  <div class="flex items-center space-x-2">
                    <input type="text" class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none"
                      placeholder="Programa 2" v-model="formData.programa2"
                      :disabled="formData.sistemas === 'No' || !formData.sistemas" />
                  </div>
                </td>
                <td class="border border-gray-300 p-2 text-center">
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.nivelP2" value="R" class="mr-2"
                      :disabled="!formData.programa2" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.nivelP2" value="B" class="mr-2"
                      :disabled="!formData.programa2" />
                    <label class="mr-2">MB</label>
                ...
                <td class="border border-gray-300 p-2">
                  <div class="flex items-center space-x-2">
                    <input type="text" class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none"
                      placeholder="Programa 4" v-model="formData.programa4"
                      :disabled="formData.sistemas === 'No' || !formData.sistemas" />
                  </div>
                </td>
                <td class="border border-gray-300 p-2 text-center">
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.nivelP4" value="R" class="mr-2"
                      :disabled="!formData.programa4" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.nivelP4" value="B" class="mr-2"
                      :disabled="!formData.programa4" />
                    <label class="mr-2">MB</label>
            ...
            <tbody>
              <tr>
                <td rowspan="2" class="border border-gray-300 p-2 ">
                  ...
                  <div class="flex space-x-2">
                    <label>
                      <input type="radio" v-model="formData.idiomas" value="Si" class="mr-2" />
                      Sí
                    </label>
                    <label class="ml-4">
                      <input type="radio" v-model="formData.idiomas" value="No" class="mr-2" />
                      No
                    </label>
                  </div>
                ...
                <td class="border border-gray-300 p-2">
                  <div class="flex items-center space-x-2">
                    <input type="text" class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none"
                      placeholder="Idioma 1" v-model="formData.idioma1"
                ...
                <td class="border border-gray-300 p-2 text-center">
                  ...
                  <div class="flex space-x-2 text-center">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.lecturaI1" value="R" class="mr-2"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.lecturaI1" value="B" class="mr-2"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                    <label class="mr-2">MB</label>
                ...
                <td class="border border-gray-300 p-2 text-center">
                  ...
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.escrituraI1" value="R" class="mr-2"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.escrituraI1" value="B" class="mr-2"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                    <label class="mr-2">MB</label>
                    <input type="radio" v-model="formData.escrituraI1" value="MB"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                  </div>
                ...
                <td class="border border-gray-300 p-2 text-center">
                  ...
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.habladoI1" value="R" class="mr-2"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.habladoI1" value="B" class="mr-2"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                    <label class="mr-2">MB</label>
                    <input type="radio" v-model="formData.habladoI1" value="MB"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                  </div>
              ...
              <tr>
                <td class="border border-gray-300 p-2">
                  <div class="flex items-center space-x-2">
                    <input type="text" class="w-full px-3 py-2 border-none rounded-lg text-gray-700 focus:outline-none"
                      placeholder="Idioma 2" v-model="formData.idioma2"
                      :disabled="formData.idiomas === 'No' || !formData.idiomas" />
                  </div>
                </td>
                <td class="border border-gray-300 p-2 text-center">
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.lecturaI2" value="R" class="mr-2"
                      :disabled="!formData.idioma2" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.lecturaI2" value="B" class="mr-2"
                      :disabled="!formData.idioma2" />
                    <label class="mr-2">MB</label>
                ...
                <td class="border border-gray-300 p-2 text-center">
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.escrituraI2" value="R" class="mr-2"
                      :disabled="!formData.idioma2" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.escrituraI2" value="B" class="mr-2"
                      :disabled="!formData.idioma2" />
                    <label class="mr-2">MB</label>
                ...
                <td class="border border-gray-300 p-2 text-center">
                  <div class="flex space-x-2">
                    <label class="mr-2">R</label>
                    <input type="radio" v-model="formData.habladoI2" value="R" class="mr-2"
                      :disabled="!formData.idioma2" />
                    <label class="mr-2">B</label>
                    <input type="radio" v-model="formData.habladoI2" value="B" class="mr-2"
                      :disabled="!formData.idioma2" />
                    <label class="mr-2">MB</label>
