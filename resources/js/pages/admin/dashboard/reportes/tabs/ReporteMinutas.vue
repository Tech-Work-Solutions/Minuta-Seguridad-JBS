    ...
    <div class="flex flex-col min-w-0 w-full shadow-lg rounded-lg bg-gray-100 border-1">         
      <div class="flex-auto px-4 lg:px-0 py-10 pt-0">
        <form>
          <div class="flex flex-wrap mx-2 mt-10">
            ...
            <div class="w-full lg:w-3/12 px-4">
              ...
              <p class="text-red-500 text-sm" v-if="submited && !$v.formData.fecha_inicial.required">Ingrese una fecha inicial</p>
            </div>
            ...
            <div class="w-full lg:w-3/12 px-4">
              ...
              <p class="text-red-500 text-sm" v-if="submited && !$v.formData.fecha_final.required">Ingrese una fecha final</p>
            </div>
        ...
        <div class="block w-full overflow-x-auto mx-3 mt-6">
          <div v-if="!showResult" class="bg-blue-100 border-t-4 mb-2 border-blue-500 rounded-b text-teal-900 py-3 shadow-md" role="alert">
            <div class="flex">
              ...
              <tr v-for="item in datos" :key="item.id">
                  ...
                  >
                    <div class="flex flex-wrap justify-center">
                      ...
                      <div
                          @click="openModal(item)" title="Eliminar registro"
...
export default {
  ...
  methods: {
    ...
    makePDF() { 
      location.href = '/api/pdf_recordMinuta?user_id='+this.formData.user_id+'&fecha_inicial='+this.formData.fecha_inicial+'&fecha_final='+this.formData.fecha_final;
    },
