            ...
            <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row">
               ...
               <li class="m-2 last:mr-0 flex-auto text-center cursor-pointer max-w-xs">
                  <a class="text-sm font-bold px-5 py-3 shadow-lg rounded block leading-normal"
                     ...
                     <em class="fas fa-user-circle"></em> Imagen reporte
                  </a>
               </li>
            </ul>
...
import ReporteConfiguracion from './tabs/ReporteConfiguracion.vue';
export default {
   name: "tabs",
   data() {
      return {
   ...
   components: { Vehiculos, Conductores, Procedencias, Volquetas, Eps, Arl, Subject, TipoDocumento, Ubicacion, Clientes, Sedes, ReporteConfiguracion }
}
</script>